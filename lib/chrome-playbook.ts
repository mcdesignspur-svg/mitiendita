...
Ve a alibaba.com y busca según los parámetros del brief: categorías foco, retail ~3–4× el costo, MOQ alcanzable, baja fricción logística. Respeta el surtido: NADA de belleza, bienestar, skincare, suplementos ni salud. No dupliques lo ya conocido. Junta hasta el "máx por corrida" de candidatos buenos. Para cada uno captura: nombre, foto (imageUrl), enlace (sourceUrl), costo unitario estimado, MOQ y el nombre del suplidor. Los precios son ESTIMADOS (no inventes "confirmados").
